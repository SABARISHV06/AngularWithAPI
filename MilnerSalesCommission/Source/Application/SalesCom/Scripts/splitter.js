    ...
    $.fn.splitter = function (args) {
        ...
        return this.each(function () {
            ...
            function startSplitMouse(evt) {
                $("#panelimagediv").css("visibility", "hidden");
                if (evt.which != 1)
            ...
            function endSplitMouse(evt) {
                ...
                AdjustIframePageWidth();
                $("#panelimagediv").css("visibility", "visible");               
            }
...
function SetIframePageWidth() {
    var windowWidth = $(window).width();
    if (!$(".splitter-bar").is(":visible")) {
        $("iframe").css("width", (parseInt(windowWidth) - 60) + "px");
    }
    else {
        var rightPanelXPosition = $("#RightPanel").css("left").replace("px", "");
        $("iframe").css("width", (parseInt(windowWidth) - parseInt(rightPanelXPosition) - 10) + "px");
    }
}

function AdjustIframePageWidth() {
    setTimeout("SetIframePageWidth()", 100);
}
