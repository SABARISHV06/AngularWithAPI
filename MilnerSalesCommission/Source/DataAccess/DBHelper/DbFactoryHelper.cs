...
namespace DBContext
{
    ...
    /// </summary>
    public sealed class DbFactoryHelper
    {
        #region commanded code
        //private static string m_ConnectionString = null;

        //public static string GetDatabaseConnectionString()
        //{
        //    GlobalConfig.GlobalConfiguration conig = new GlobalConfig.GlobalConfiguration();
        //    conig.LoadGlobalSettings();

        //    string rawString = GetInitialConnectionStringFormats();
        //    if (rawString.EndsWith(";"))
        //    {

        //        return GetInitialConnectionStringFormats() + string.Format("Initial Catalog={0};User id={1};Password={2};", conig.InitialCatalog, conig.DBUserID, conig.Password); // "Initial Catalog=SalesComDB";
        //    }
        //    else
        //    {
        //        return GetInitialConnectionStringFormats() + string.Format("Initial Catalog={0};User id={1};Password={2};", conig.InitialCatalog,conig.DBUserID, conig.Password); // "Initial Catalog=SalesComDB";
        ...
        //public static string GetInitialConnectionStringFormats()
        //{
        //    GlobalConfig.GlobalConfiguration conig = new GlobalConfig.GlobalConfiguration();
        //    conig.LoadGlobalSettings();
        ...
        //    if (string.IsNullOrWhiteSpace(m_ConnectionString))
        //    {
        //        m_ConnectionString = string.Format("Data Source={0};Integrated Security={1};", conig.DataSource, conig.IntegratedSecurity); // @"Data Source=(local)\SQLEXPRESSADV;Integrated Security=True";
        //    }

        //    try
        //    {
        //        if (!m_ConnectionString.Contains("Connection Timeout") && !m_ConnectionString.Contains("Connect Timeout"))
        //        {
        //            if (m_ConnectionString.EndsWith(";"))
        //            {
        //                m_ConnectionString = string.Format("{0}Connection Timeout={1};", m_ConnectionString, conig.ConnectionTimeout);
        //            }
        //            else
        //            {
        //                m_ConnectionString = string.Format("{0};Connection Timeout={1};", m_ConnectionString, conig.ConnectionTimeout);
        ...
        //    catch (Exception ex)
        //    {
        //        throw new Exception("Failed to retrieve sql database Connection string.", ex);
        //    }
        ...
        /// <summary>
        /// To build database connection string based on the configuration. 
        /// </summary>
        /// <returns></returns>
        public static string GetDatabaseConnectionString()
        {
            try
            {
                GlobalConfig.GlobalConfiguration conig = new GlobalConfig.GlobalConfiguration();
                conig.LoadGlobalSettings();
                if (conig.IsSaveAllowed()) { conig.SaveGlobalSettings(); }
                SqlConnectionStringBuilder myBuilder = new SqlConnectionStringBuilder();
                myBuilder.UserID = string.IsNullOrEmpty(conig.DBUserID) ? null : conig.DBUserID;
                myBuilder.Password = string.IsNullOrEmpty(conig.Password) ? null : conig.Password;
        ...
        /// <param name="commandParameters">an array of DbParameters tho be added to command</param>
        ...
        /// <remarks>
        /// e.g.:  
        ///  int result = ExecuteNonQuery(connString, CommandType.StoredProcedure, "PublishOrders", DbFactory.NewParameter("@prodid", 24));
        /// </remarks>
        /// <param name="connectionString">a valid connection string for a DbConnection</param>
        /// <param name="commandType">the CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">the stored procedure name or T-SQL command</param>
        ...
        public static int ExecuteNonQuery(string connectionString, CommandType commandType, string commandText, params DbParameter[] commandParameters)
        {
            ...
            using (DbConnection cn = DbFactory.NewConnection(connectionString))
            {
                cn.Open();
        ...
        /// <remarks>
        /// e.g.:  
        ///  int result = ExecuteNonQuery(conn, CommandType.StoredProcedure, "PublishOrders", DbFactory.NewParameter("@prodid", 24));
        /// </remarks>
        /// <param name="connection">a valid DbConnection</param>
        /// <param name="commandType">the CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">the stored procedure name or T-SQL command</param>
        ...
        public static int ExecuteNonQuery(DbConnection connection, CommandType commandType, string commandText, params DbParameter[] commandParameters)
        {
            ...
            DbCommand cmd = DbFactory.NewCommand();
        ...
        public static int ExecuteNonQuery(DbConnection connection, string spName, params object[] parameterValues)
        {
            ...
            {
                //pull the parameters for this stored procedure from the parameter cache (or discover them & populate the cache)
                DbParameter[] commandParameters = SqlHelperParameterCache.GetSpParameterSet(connection.ConnectionString, spName);
        ...
        /// <remarks>
        /// e.g.:  
        ///  int result = ExecuteNonQuery(trans, CommandType.StoredProcedure, "GetOrders", DbFactory.NewParameter("@prodid", 24));
        /// </remarks>
        /// <param name="transaction">a valid DbTransaction</param>
        /// <param name="commandType">the CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">the stored procedure name or T-SQL command</param>
        ...
        public static int ExecuteNonQuery(DbTransaction transaction, string spName, params object[] parameterValues)
        {
            ...
            {
                //pull the parameters for this stored procedure from the parameter cache (or discover them & populate the cache)
                DbParameter[] commandParameters = SqlHelperParameterCache.GetSpParameterSet(transaction.Connection.ConnectionString, spName);
        ...
        /// <remarks>
        /// e.g.:  
        ///  DataSet ds = ExecuteDataset(connString, CommandType.StoredProcedure, "GetOrders", DbFactory.NewParameter("@prodid", 24));
        /// </remarks>
        /// <param name="connectionString">a valid connection string for a DbConnection</param>
        /// <param name="commandType">the CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">the stored procedure name or T-SQL command</param>
        ...
        /// <remarks>
        /// e.g.:  
        ///  DataSet ds = ExecuteDataset(conn, CommandType.StoredProcedure, "GetOrders", DbFactory.NewParameter("@prodid", 24));
        /// </remarks>
        /// <param name="connection">a valid DbConnection</param>
        /// <param name="commandType">the CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">the stored procedure name or T-SQL command</param>
        ...
        public static DataSet ExecuteDataset(DbConnection connection, CommandType commandType, string commandText, params DbParameter[] commandParameters)
        {
            ...
            DbDataAdapter da = DbFactory.NewDataAdapter(cmd);
        ...
        /// <remarks>
        /// e.g.:  
        ///  DataSet ds = ExecuteDataset(trans, CommandType.StoredProcedure, "GetOrders", DbFactory.NewParameter("@prodid", 24));
        /// </remarks>
        /// <param name="transaction">a valid DbTransaction</param>
        /// <param name="commandType">the CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">the stored procedure name or T-SQL command</param>
        ...
        /// <remarks>
        /// e.g.:  
        ///  DbDataReader dr = ExecuteReader(connString, CommandType.StoredProcedure, "GetOrders", DbFactory.NewParameter("@prodid", 24));
        /// </remarks>
        /// <param name="connectionString">a valid connection string for a DbConnection</param>
        /// <param name="commandType">the CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">the stored procedure name or T-SQL command</param>
        ...
        {
            //create & open a DbConnection
            DbConnection cn = DbFactory.NewConnection(connectionString);
            cn.Open();
        ...
        /// <remarks>
        /// e.g.:  
        ///  DbDataReader dr = ExecuteReader(conn, CommandType.StoredProcedure, "GetOrders", DbFactory.NewParameter("@prodid", 24));
        /// </remarks>
        /// <param name="connection">a valid DbConnection</param>
        /// <param name="commandType">the CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">the stored procedure name or T-SQL command</param>
        ...
        /// <remarks>
        /// e.g.:  
        ///   DbDataReader dr = ExecuteReader(trans, CommandType.StoredProcedure, "GetOrders", DbFactory.NewParameter("@prodid", 24));
        /// </remarks>
        /// <param name="transaction">a valid DbTransaction</param>
        /// <param name="commandType">the CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">the stored procedure name or T-SQL command</param>
        ...
        /// <remarks>
        /// e.g.:  
        ///  int orderCount = (int)ExecuteScalar(connString, CommandType.StoredProcedure, "GetOrderCount", DbFactory.NewParameter("@prodid", 24));
        /// </remarks>
        /// <param name="connectionString">a valid connection string for a DbConnection</param>
        /// <param name="commandType">the CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">the stored procedure name or T-SQL command</param>
        ...
        /// <remarks>
        /// e.g.:  
        ///  int orderCount = (int)ExecuteScalar(conn, CommandType.StoredProcedure, "GetOrderCount", DbFactory.NewParameter("@prodid", 24));
        /// </remarks>
        /// <param name="connection">a valid DbConnection</param>
        /// <param name="commandType">the CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">the stored procedure name or T-SQL command</param>
        ...
        /// <remarks>
        /// e.g.:  
        ///  int orderCount = (int)ExecuteScalar(trans, CommandType.StoredProcedure, "GetOrderCount", DbFactory.NewParameter("@prodid", 24));
        /// </remarks>
        /// <param name="transaction">a valid DbTransaction</param>
        /// <param name="commandType">the CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">the stored procedure name or T-SQL command</param>
    ...
    public sealed class SqlHelperParameterCache
    {
        ...
        {
            using (DbConnection cn = DbFactory.NewConnection(connectionString))
            using (DbCommand cmd = DbFactory.NewCommand(spName, cn))
            {
                cn.Open();
